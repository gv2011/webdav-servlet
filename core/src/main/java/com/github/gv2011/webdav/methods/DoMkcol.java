...
public class DoMkcol extends AbstractMethod {
    ...
    public DoMkcol(final IWebdavStore store, final IResourceLocks resourceLocks,
    ...
    public void execute(final ITransaction transaction, final HttpServletRequest req,
        ...
        if (!_readOnly) {
            ...
            final String tempLockOwner = "doMkcol" + System.currentTimeMillis()
                    + req.toString();
					...
					if (parentPath != null && parentSo.isFolder()) {
                        ...
                        if (so == null) {
                            ...
                            if (so.isNullResource()) {
                                ...
                                final LockedObject nullResourceLo = _resourceLocks
                                ...
                                final String nullResourceLockToken = nullResourceLo
                                        .getID();
                                ...
                                if (lockToken.equals(nullResourceLockToken)) {
                                    ...
                                    final String[] nullResourceLockOwners = nullResourceLo
                                            .getOwner();
                                    String owner = null;
