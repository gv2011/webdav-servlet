...
public class DoGet extends DoHead {
     ...
     * @return
     */
    protected String getHeader(final ITransaction transaction, final String path,
            final HttpServletResponse resp, final HttpServletRequest req)
    {
     ...
     * @return
     */
    protected String getFooter(final ITransaction transaction, final String path,
            final HttpServletResponse resp, final HttpServletRequest req)
    {
        return "";
    }
