package com.github.gv2011.webdav.testutil;
...
import com.github.gv2011.webdav.methods.TestingOutputStream;
...
public abstract class MockTest extends Assert {
    ...
    private static StoredObject initStoredObject(final boolean isFolder,
    ...
    public static LockedObject initLockNullLockedObject(final ResourceLocks resLocks,
            final String path) {
