...
import com.github.gv2011.webdav.exceptions.ObjectNotFoundException;
import com.github.gv2011.webdav.exceptions.WebdavException;
import com.github.gv2011.webdav.fromcatalina.RequestUtil;
...
public class DoCopy extends AbstractMethod {
    ...
    public DoCopy(final IWebdavStore store, final ResourceLocks resourceLocks,
            final DoDelete doDelete, final boolean readOnly) {
        _store = store;
    ...
    public void execute(final ITransaction transaction, final HttpServletRequest req,
        ...
        if (!_readOnly) {
            ...
            final String tempLockOwner = "doCopy" + System.currentTimeMillis()
                    + req.toString();
     ...
     */
    public boolean copyResource(final ITransaction transaction,
        ...
        final String lockOwner = "copyResource" + System.currentTimeMillis()
                + req.toString();
     ...
     * @throws IOException
     */
    private void copy(final ITransaction transaction, final String sourcePath,
            final String destinationPath, final Hashtable<String, Integer> errorList,
            final HttpServletRequest req, final HttpServletResponse resp)
        ...
        if (sourceSo.isResource()) {
            ...
            final long resourceLength = _store.setResourceContent(transaction,
                    destinationPath, _store.getResourceContent(transaction,
                            sourcePath), null, null);

            if (resourceLength != -1) {
                final StoredObject destinationSo = _store.getStoredObject(
     ...
     *      if an error in the underlying store occurs
     */
    private void copyFolder(final ITransaction transaction, final String sourcePath,
            final String destinationPath, final Hashtable<String, Integer> errorList,
            final HttpServletRequest req, final HttpServletResponse resp)
            throws WebdavException {
     ...
     */
    private String parseDestinationHeader(final HttpServletRequest req,
        ...
        if (protocolIndex >= 0) {
            ...
            final int firstSeparator = destinationPath
