...
public final class RequestUtil {
    ...
    public static String encodeCookie(final Cookie cookie) {
        ...
        final StringBuffer buf = new StringBuffer(cookie.getName());
        buf.append("=");
    ...
    public static Cookie[] parseCookieHeader(String header) {
        ...
        while (header.length() > 0) {
            ...
            try {
                ...
                if (equals > 0) {
                    final String name = token.substring(0, equals).trim();
     ...
     */
    public static void parseParameters(final Map<String, String[]> map, final String data,
     ...
     *      The parameter value
     */
    private static void putMapEntry(final Map<String, String[]> map, final String name,
            final String value) {
     ...
     *      if the data is malformed
     */
    public static void parseParameters(final Map<String, String[]> map, final byte[] data,
            final String encoding) throws UnsupportedEncodingException {
