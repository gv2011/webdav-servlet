...
public class DoDelete extends AbstractMethod {
    ...
    public DoDelete(final IWebdavStore store, final ResourceLocks resourceLocks,
    ...
    public void execute(final ITransaction transaction, final HttpServletRequest req,
        ...
        if (!_readOnly) {
            ...
            final String tempLockOwner = "doDelete" + System.currentTimeMillis()
                    + req.toString();
    ...
    public void deleteResource(final ITransaction transaction, final String path,
            final Hashtable<String, Integer> errorList, final HttpServletRequest req,
            final HttpServletResponse resp) throws IOException, WebdavException {
